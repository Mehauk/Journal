...
1. Build the IPADIC dictionary to be packaged alongside the android application. You may also be able to use a different dictionary.
...
- [[Compiling MeCab for Android/Building IPADIC|Building IPADIC]]
